...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and…<br/>…<br/>Train a DecisionTreeClassif…"]
    CURSES["<b>Current Session</b><br/><b>Random Forests & Ensemble Metho…</b><br/><i>Shift:</i> Learn patterns that separate classes<br/>Train a RandomForestClassifier and extract feat…<br/>compare random forest vs single decision tree o…"]
end
