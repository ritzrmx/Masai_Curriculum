...
direction TB
    ...
    CURSES["<b>Current Session</b><br/><b>ML Workflow & Problem Framing</b><br/><i>Shift:</i> Frame ML problems before picking models<br/>Distinguish supervised and unsupervised learnin…<br/>split data using train_test_split and evaluate…"]
end
