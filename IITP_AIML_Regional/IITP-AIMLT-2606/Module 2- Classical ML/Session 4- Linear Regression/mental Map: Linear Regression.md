...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and unsupervised…<br/>Data Preparation for ML<br/>Linear Equations & The Equation of a Li…"]
    CURSES["<b>Current Session</b><br/><b>Linear Regression</b><br/><i>Shift:</i> Predict numbers with interpretable lines<br/>Train a LinearRegression model using scikit-lea…<br/>evaluate model performance using MAE, RMSE and…"]
end
