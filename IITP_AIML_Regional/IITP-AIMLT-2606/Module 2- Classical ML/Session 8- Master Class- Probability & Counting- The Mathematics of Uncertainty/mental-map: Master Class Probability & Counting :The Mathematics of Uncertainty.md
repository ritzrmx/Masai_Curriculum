...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and…<br/>…<br/>Compute and interpret all c…"]
    CURSES["<b>Current Session</b><br/><b>Master Class Probability & Coun…</b><br/><i>Shift:</i> Turn business rules into executable log…<br/>Probability Fundamentals"]
end
