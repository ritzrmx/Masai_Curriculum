...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and…<br/>…<br/>Probability Fundamentals"]
    CURSES["<b>Current Session</b><br/><b>Decision Trees</b><br/><i>Shift:</i> Connect modeling choices to Train a Dec…<br/>Train a DecisionTreeClassifier and visualize it…<br/>analyze overfitting by comparing train vs test…"]
end
