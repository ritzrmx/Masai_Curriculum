...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and…<br/>…<br/>Implement k-fold and strati…"]
    CURSES["<b>Current Session</b><br/><b>Clustering, Model Selection & E…</b><br/><i>Shift:</i> Find structure without labels<br/>Run KMeans clustering and determine optimal k u…<br/>compare multiple trained models using a structu…"]
end
