...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and…<br/>…<br/>Train a RandomForestClassif…"]
    CURSES["<b>Current Session</b><br/><b>Model Validation & Leakage</b><br/><i>Shift:</i> Evaluate models that generalize<br/>Implement k-fold and stratified k-fold cross-va…<br/>tune hyperparameters using GridSearchCV and int…"]
end
