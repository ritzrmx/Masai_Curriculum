...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and… · Data Preparat…<br/>Linear Equations & The Equa… · Train a Line…"]
    CURSES["<b>Current Session</b><br/><b>Regularization</b><br/><i>Shift:</i> Control complexity—not just fit harder<br/>Apply Ridge and Lasso regression to reduce over…<br/>tune the alpha hyperparameter and observe its e…"]
end
