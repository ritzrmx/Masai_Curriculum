...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Distinguish supervised and unsupervised…"]
    CURSES["<b>Current Session</b><br/><b>Data Preparation for ML</b><br/><i>Shift:</i> Trustworthy features beat fancy algorit…<br/>Build an end-to-end preprocessing pipeline usin…<br/>apply correct encoding and scaling strategies f…"]
end
