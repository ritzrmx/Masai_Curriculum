...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>Recall and distinguish AI,…<br/>…<br/>Write SQL queries to filter…"]
    CURSES["<b>Current Session</b><br/><b>Data Analysis with Spreadsheets</b><br/><i>Shift:</i> Turn business rules into executable log…<br/>Use VLOOKUP and XLOOKUP to retrieve values acro…<br/>build pivot tables to summarize and slice data"]
end
