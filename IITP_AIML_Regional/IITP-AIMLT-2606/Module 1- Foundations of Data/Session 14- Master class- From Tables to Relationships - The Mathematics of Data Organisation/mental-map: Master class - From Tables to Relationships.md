...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>Recall and distinguish AI,…<br/>…<br/>Execute a structured EDA on…"]
    CURSES["<b>Current Session</b><br/><b>Master class:From Tables to Rel…</b><br/><i>Shift:</i> Connect math intuition to how models le…<br/>Coordinate Geometry & Visualisation Intuition"]
end
