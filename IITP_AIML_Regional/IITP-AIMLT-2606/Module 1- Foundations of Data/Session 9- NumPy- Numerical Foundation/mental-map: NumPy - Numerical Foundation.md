...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>Recall and distinguish AI,…<br/>…<br/>Read and write files safely…"]
    CURSES["<b>Current Session</b><br/><b>NumPy: Numerical Foundation</b><br/><i>Shift:</i> Think in vectors—speed for AI math<br/>Create and manipulate NumPy arrays using indexi…<br/>perform element-wise arithmetic and broadcastin…"]
end
