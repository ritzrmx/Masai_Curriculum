...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI<br/>Computer basics<br/>Command Line (CLI) basics"]
    CURSES["<b>Current Session</b><br/><b>Python: Logic & Flow</b><br/><i>Shift:</i> Code becomes your daily thinking langua…<br/>Variables<br/>Data types (Int"]
end
