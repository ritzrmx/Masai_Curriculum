...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI · Computer basics<br/>Command Line (CLI) basics · Variables<br/>For loops · Defining functions"]
    CURSES["<b>Current Session</b><br/><b>Python: Files & JSON</b><br/><i>Shift:</i> Bridge programs to real files and APIs<br/>Reading and writing files<br/>Context managers (With blocks)"]
end
