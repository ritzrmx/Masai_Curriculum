...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI · Computer basics<br/>Command Line (CLI) basics · Variables<br/>For loops"]
    CURSES["<b>Current Session</b><br/><b>Python: Functions & Modularity</b><br/><i>Shift:</i> Design reusable building blocks, not on…<br/>Defining functions<br/>Parameters and Arguments"]
end
