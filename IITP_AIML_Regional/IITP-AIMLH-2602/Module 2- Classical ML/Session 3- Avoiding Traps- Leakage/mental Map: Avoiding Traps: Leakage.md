...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing<br/>Categorical encoding"]
    CURSES["<b>Current Session</b><br/><b>Avoiding Traps: Leakage</b><br/><i>Shift:</i> Evaluate models that generalize<br/>Data leakage guard<br/>Simple Cross-validation"]
end
