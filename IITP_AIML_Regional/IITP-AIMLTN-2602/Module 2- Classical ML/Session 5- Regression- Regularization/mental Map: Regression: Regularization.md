...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing · Categorical encoding<br/>Data leakage guard · Linear Regression"]
    CURSES["<b>Current Session</b><br/><b>Regression: Regularization</b><br/><i>Shift:</i> Control complexity—not just fit harder<br/>Lasso and Ridge regression<br/>Alpha tuning"]
end
