...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing<br/>…<br/>Confusion Matrix"]
    CURSES["<b>Current Session</b><br/><b>Visualizing Performance (ROC-AU…</b><br/><i>Shift:</i> Tune decisions for business trade-offs<br/>Confusion Matrix & TPR/FPR<br/>ROC Curve Construction"]
end
