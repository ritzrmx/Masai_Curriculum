...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing · Categorical encoding<br/>Data leakage guard · Linear Regression<br/>Lasso and Ridge regression · MAE"]
    CURSES["<b>Current Session</b><br/><b>Classification: Logistic Regres…</b><br/><i>Shift:</i> Learn patterns that separate classes<br/>The Sigmoid function<br/>Decision boundaries"]
end
