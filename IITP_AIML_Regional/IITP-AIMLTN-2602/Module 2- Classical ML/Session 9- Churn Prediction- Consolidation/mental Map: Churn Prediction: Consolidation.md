...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing<br/>…<br/>Nodes and Leaves"]
    CURSES["<b>Current Session</b><br/><b>Churn Prediction: Consolidation</b><br/><i>Shift:</i> Connect modeling choices to Bagging<br/>Bagging<br/>Forest parameters"]
end
