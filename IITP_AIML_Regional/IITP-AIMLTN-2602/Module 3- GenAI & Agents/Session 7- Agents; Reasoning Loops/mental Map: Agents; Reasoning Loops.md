...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>Tokens · Zero-shot<br/>API calls · JSON schema<br/>Text embeddings · Retrieval pipeline"]
    CURSES["<b>Current Session</b><br/><b>Agents; Reasoning Loops</b><br/><i>Shift:</i> Design agents that act, not only chat<br/>ReAct framework<br/>Planning"]
end
