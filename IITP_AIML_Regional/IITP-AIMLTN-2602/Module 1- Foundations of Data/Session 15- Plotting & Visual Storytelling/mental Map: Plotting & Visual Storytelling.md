...
direction TB
    ...
    CURSES["<b>Current Session</b><br/><b>Plotting & Visual Storytelling</b><br/><i>Shift:</i> Turn numbers into decisions via visuals<br/>Matplotlib foundations<br/>Seaborn statistics plots"]
end
