...
exam_score    = np.array([45, 55, 60, 68, 75, 82, 88])
```
...
Add the title `"Study Hours vs Exam Score"` and label both axes.

**Task 3 — Mid**
Calculate the **slope** of the best-fit line using:

> slope = Σ((x − x̄)(y − ȳ)) / Σ((x − x̄)²)

Then calculate **intercept** = ȳ − slope × x̄. Print both (round to 2 decimals) and complete the sentence:
*"For every extra hour studied, score increases by ___ points."*
...
```
Mean: 67.6   Median: 68.0   Std: 14.2

[scatter plot displayed]

Slope: 7.07   Intercept: 32.21
For every extra hour studied, score increases by 7.07 points.
```
