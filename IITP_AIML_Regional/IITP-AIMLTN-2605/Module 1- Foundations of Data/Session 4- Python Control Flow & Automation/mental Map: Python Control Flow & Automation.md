...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>The AI Landscape, Computing & Lab Setup<br/>Developer Toolkit: Terminal, Git & Pyth…<br/>Lists, Tuples, Sets, dictionaries - Bas…"]
    CURSES["<b>Current Session</b><br/><b>Python Control Flow & Automation</b><br/><i>Shift:</i> Replace manual repetition with loops<br/>Learn how to automate logic using loops and con…"]
end
