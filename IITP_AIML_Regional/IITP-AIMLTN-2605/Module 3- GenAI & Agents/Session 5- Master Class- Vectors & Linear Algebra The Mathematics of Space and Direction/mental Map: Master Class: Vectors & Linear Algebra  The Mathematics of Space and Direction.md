...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>GenAI Foundations & Prompt… · LLM APIs, Int…<br/>RAG & Embedding Foundations · Building a RA…"]
    CURSES["<b>Current Session</b><br/><b>Master Class: Vectors & Linear…</b><br/><i>Shift:</i> Connect math intuition to how models le…<br/>Vectors from Scratch<br/>Dot Product & Angle Between Vectors"]
end
