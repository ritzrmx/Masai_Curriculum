...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>GenAI Foundations & Prompt… · LLM APIs, Int…<br/>RAG & Embedding Foundations · Building a RA…<br/>Vectors from Scratch · Agent Concepts, Auto…"]
    CURSES["<b>Current Session</b><br/><b>Agent Orchestration with LangGr…</b><br/><i>Shift:</i> Orchestrate multi-step agent flows<br/>Learn to structure and control agent workflows."]
end
