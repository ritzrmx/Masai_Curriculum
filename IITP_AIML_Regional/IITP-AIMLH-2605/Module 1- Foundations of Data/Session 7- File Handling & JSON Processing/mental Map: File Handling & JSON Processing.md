...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI · VS Code<br/>Variables · Lists, Tuples, Sets, dictio…<br/>Loops · Number Systems & Boolean Lo…"]
    CURSES["<b>Current Session</b><br/><b>File Handling & JSON Processing</b><br/><i>Shift:</i> Bridge programs to real files and APIs<br/>File I/O<br/>JSON"]
end
