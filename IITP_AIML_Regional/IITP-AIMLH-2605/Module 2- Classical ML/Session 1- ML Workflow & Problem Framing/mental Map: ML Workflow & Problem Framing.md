...
direction TB
    ...
    CURSES["<b>Current Session</b><br/><b>ML Workflow & Problem Framing</b><br/><i>Shift:</i> Frame ML problems before picking models<br/>ML pipeline<br/>Features vs Labels"]
end
