...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>Overview of LLMs<br/>…<br/>FastAPI basics"]
    CURSES["<b>Current Session</b><br/><b>Orchestration and Agent Workflo…</b><br/><i>Shift:</i> Orchestrate multi-step agent flows<br/>LangGraph basics<br/>Nodes and transitions"]
end
