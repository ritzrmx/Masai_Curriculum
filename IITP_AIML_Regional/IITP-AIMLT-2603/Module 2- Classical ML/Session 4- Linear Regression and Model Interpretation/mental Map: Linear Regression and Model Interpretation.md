...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Machine learning overview<br/>Handling missing values<br/>Train/validation/test split"]
    CURSES["<b>Current Session</b><br/><b>Linear Regression and Model Int…</b><br/><i>Shift:</i> Predict numbers with interpretable lines<br/>Linear regression model<br/>Coefficients and interpretation"]
end
