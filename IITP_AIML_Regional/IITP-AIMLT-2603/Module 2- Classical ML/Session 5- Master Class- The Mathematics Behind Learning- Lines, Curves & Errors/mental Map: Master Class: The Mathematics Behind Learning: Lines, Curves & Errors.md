...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Machine learning overview · Handling missin…<br/>Train/validation/test split · Linear regres…"]
