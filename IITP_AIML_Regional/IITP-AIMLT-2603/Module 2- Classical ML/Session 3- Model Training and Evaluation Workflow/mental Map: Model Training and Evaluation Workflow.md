...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Machine learning overview<br/>Handling missing values"]
    CURSES["<b>Current Session</b><br/><b>Model Training and Evaluation W…</b><br/><i>Shift:</i> Frame ML problems before picking models<br/>Train/validation/test split<br/>Baseline models"]
end
