...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Machine learning overview<br/>…<br/>Cross-validation"]
    CURSES["<b>Current Session</b><br/><b>ROC Curve and Threshold Optimiz…</b><br/><i>Shift:</i> Tune decisions for business trade-offs<br/>ROC curve<br/>AUC score"]
end
