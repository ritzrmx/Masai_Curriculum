...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Machine learning overview · Handling missin…<br/>Train/validation/test split · Linear regres…<br/>Linear Equations & The Equa…"]
    CURSES["<b>Current Session</b><br/><b>Regression Evaluation and Error…</b><br/><i>Shift:</i> Measure error the way stakeholders unde…<br/>MAE<br/>RMSE"]
end
