...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI<br/>VS Code setup<br/>Variables"]
    CURSES["<b>Current Session</b><br/><b>Control Flow in Python</b><br/><i>Shift:</i> Turn business rules into executable log…<br/>Conditional statements (if, elif, else)<br/>Boolean logic"]
end
