...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI<br/>…<br/>JSON structure"]
    CURSES["<b>Current Session</b><br/><b>File Handling and Data Processi…</b><br/><i>Shift:</i> Bridge programs to real files and APIs<br/>File input/output operations<br/>Reading and writing files"]
end
