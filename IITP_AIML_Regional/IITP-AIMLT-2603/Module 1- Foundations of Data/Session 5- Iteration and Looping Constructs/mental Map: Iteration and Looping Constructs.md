...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI · VS Code setup<br/>Variables · Conditional statements (if,…"]
    CURSES["<b>Current Session</b><br/><b>Iteration and Looping Constructs</b><br/><i>Shift:</i> Strengthen data foundations around For…<br/>For loops<br/>While loops"]
end
