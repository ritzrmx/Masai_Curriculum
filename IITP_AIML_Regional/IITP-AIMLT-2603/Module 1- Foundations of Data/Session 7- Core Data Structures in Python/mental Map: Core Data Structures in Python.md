...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI · VS Code setup<br/>Variables · Conditional statements (if,…<br/>For loops · Function definition"]
    CURSES["<b>Current Session</b><br/><b>Core Data Structures in Python</b><br/><i>Shift:</i> Pick the right in-memory data shape<br/>Lists (indexing, slicing, iteration)<br/>Dictionaries (key-value operations)"]
end
