...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI<br/>VS Code setup"]
    CURSES["<b>Current Session</b><br/><b>Python Fundamentals</b><br/><i>Shift:</i> Code becomes your daily thinking langua…<br/>Variables<br/>Data types (int, float, string, boolean)"]
end
