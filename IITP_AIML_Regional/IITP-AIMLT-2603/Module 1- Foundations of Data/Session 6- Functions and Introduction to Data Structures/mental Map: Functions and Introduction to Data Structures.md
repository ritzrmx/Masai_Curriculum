...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs Generative AI · VS Code setup<br/>Variables · Conditional statements (if,…<br/>For loops"]
    CURSES["<b>Current Session</b><br/><b>Functions and Introduction to D…</b><br/><i>Shift:</i> Design reusable building blocks, not on…<br/>Function definition<br/>Parameters and arguments"]
end
