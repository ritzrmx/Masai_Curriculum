...
direction TB
    ...
    CURSES["<b>Current Session</b><br/><b>The AI Landscape and Computing…</b><br/><i>Shift:</i> See AI as a career map—not hype<br/>AI vs ML vs Generative AI<br/>Industry use cases"]
end
