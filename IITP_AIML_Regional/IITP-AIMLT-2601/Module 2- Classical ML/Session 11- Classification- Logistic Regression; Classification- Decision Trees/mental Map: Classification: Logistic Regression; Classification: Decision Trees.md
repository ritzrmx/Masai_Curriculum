...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values<br/>…<br/>Bagging"]
    CURSES["<b>Current Session</b><br/><b>Classification: Logistic Regres…</b><br/><i>Shift:</i> Learn patterns that separate classes<br/>Decision boundaries<br/>Nodes and Leaves"]
end
