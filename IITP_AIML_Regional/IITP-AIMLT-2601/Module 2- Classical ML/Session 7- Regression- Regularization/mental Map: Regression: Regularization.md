...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values · Data leakage guard<br/>Problem framing · Data Cleaning and Preproc…<br/>Mean, Median, and Mode · Linear Regression…"]
    CURSES["<b>Current Session</b><br/><b>Regression: Regularization</b><br/><i>Shift:</i> Control complexity—not just fit harder<br/>Lasso and Ridge regression<br/>Tuning alpha"]
end
