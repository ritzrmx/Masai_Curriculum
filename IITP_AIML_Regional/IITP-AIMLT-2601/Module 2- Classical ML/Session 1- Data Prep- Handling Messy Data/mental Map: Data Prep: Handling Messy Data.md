...
direction TB
    ...
    CURSES["<b>Current Session</b><br/><b>Data Prep: Handling Messy Data</b><br/><i>Shift:</i> Fix messy tables before analysis<br/>Imputing missing values<br/>Removing duplicates"]
end
