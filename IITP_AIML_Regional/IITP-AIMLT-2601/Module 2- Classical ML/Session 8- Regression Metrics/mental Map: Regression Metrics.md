...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values<br/>…<br/>Lasso and Ridge regression"]
    CURSES["<b>Current Session</b><br/><b>Regression Metrics</b><br/><i>Shift:</i> Measure error the way stakeholders unde…<br/>MAE<br/>RMSE"]
end
