...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values<br/>…<br/>Decision boundaries"]
    CURSES["<b>Current Session</b><br/><b>Classification Metrics and Perf…</b><br/><i>Shift:</i> Learn patterns that separate classes<br/>Random Forest model<br/>Feature importance"]
end
