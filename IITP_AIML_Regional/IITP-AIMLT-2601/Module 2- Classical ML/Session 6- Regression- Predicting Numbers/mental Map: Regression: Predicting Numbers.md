...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values · Data leakage guard<br/>Problem framing · Data Cleaning and Preproc…<br/>Mean, Median, and Mode"]
    CURSES["<b>Current Session</b><br/><b>Regression: Predicting Numbers</b><br/><i>Shift:</i> Predict numbers with interpretable lines<br/>Linear Regression intuition<br/>Ordinary Least Squares"]
end
