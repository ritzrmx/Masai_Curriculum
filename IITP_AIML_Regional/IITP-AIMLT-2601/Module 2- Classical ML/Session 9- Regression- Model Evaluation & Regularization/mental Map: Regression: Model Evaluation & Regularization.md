...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Imputing missing values<br/>…<br/>MAE"]
    CURSES["<b>Current Session</b><br/><b>Regression: Model Evaluation &…</b><br/><i>Shift:</i> Control complexity—not just fit harder<br/>Sigmoid function<br/>Binary classification"]
end
