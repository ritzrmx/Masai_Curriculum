...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>Overview of LLMs<br/>Role prompting<br/>Single agent workflow"]
    CURSES["<b>Current Session</b><br/><b>Structured Outputs and Tool Int…</b><br/><i>Shift:</i> Make model outputs machine-safe<br/>Structured outputs (JSON)<br/>Output validation"]
end
