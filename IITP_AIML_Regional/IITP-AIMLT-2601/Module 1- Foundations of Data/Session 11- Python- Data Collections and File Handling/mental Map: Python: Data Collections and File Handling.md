...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape<br/>…<br/>Lists and Slicing"]
    CURSES["<b>Current Session</b><br/><b>Python: Data Collections and Fi…</b><br/><i>Shift:</i> Pick the right in-memory data shape<br/>Opening files (Open<br/>Close)"]
end
