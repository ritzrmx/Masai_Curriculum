...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape · Computer basi…<br/>VS Code installation · Command Line (CLI) b…<br/>Variables"]
    CURSES["<b>Current Session</b><br/><b>Python: Decision Making</b><br/><i>Shift:</i> Turn business rules into executable log…<br/>Conditionals (If-Else)<br/>Boolean logic"]
end
