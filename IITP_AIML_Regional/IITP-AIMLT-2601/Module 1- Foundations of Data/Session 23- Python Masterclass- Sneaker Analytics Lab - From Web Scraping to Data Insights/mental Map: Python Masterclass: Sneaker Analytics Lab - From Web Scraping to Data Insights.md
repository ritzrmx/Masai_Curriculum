...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape<br/>…<br/>Plotly for interactive char…"]
    CURSES["<b>Current Session</b><br/><b>Python Masterclass: Sneaker Ana…</b><br/><i>Shift:</i> Move from watching to a working dev lab<br/>Scraping product data using BeautifulSoup<br/>Extracting and structuring sneaker product deta…"]
end
