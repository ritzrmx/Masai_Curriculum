...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape<br/>…<br/>Defining functions"]
    CURSES["<b>Current Session</b><br/><b>Python: Data Collections</b><br/><i>Shift:</i> Pick the right in-memory data shape<br/>Data Structures<br/>List, set, tuple, dict overview"]
end
