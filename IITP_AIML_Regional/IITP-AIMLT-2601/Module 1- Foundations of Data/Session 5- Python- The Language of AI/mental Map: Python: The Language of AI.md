...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape · Computer basi…<br/>VS Code installation · Command Line (CLI) b…"]
    CURSES["<b>Current Session</b><br/><b>Python: The Language of AI</b><br/><i>Shift:</i> Code becomes your daily thinking langua…<br/>Variables<br/>Data types (Int"]
end
