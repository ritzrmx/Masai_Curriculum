...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape · Computer basi…<br/>VS Code installation · Command Line (CLI) b…<br/>Variables · Conditionals (If-Else)"]
    CURSES["<b>Current Session</b><br/><b>Python: Automation & Loops</b><br/><i>Shift:</i> Replace manual repetition with loops<br/>For loops<br/>While loops"]
end
