...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI landscape<br/>…<br/>For loops"]
    CURSES["<b>Current Session</b><br/><b>Python: Organizing with Functio…</b><br/><i>Shift:</i> Design reusable building blocks, not on…<br/>Defining functions<br/>Parameters and Arguments"]
end
