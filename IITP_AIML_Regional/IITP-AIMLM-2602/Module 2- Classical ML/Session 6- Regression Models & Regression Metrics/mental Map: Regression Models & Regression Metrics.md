...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Classical ML</i><br/>Problem framing · Categorical encoding<br/>Data leakage guard · Linear Regression<br/>Lasso and Ridge regression"]
    CURSES["<b>Current Session</b><br/><b>Regression Models & Regression…</b><br/><i>Shift:</i> Predict numbers with interpretable lines<br/>Linear regression<br/>MAE"]
end
