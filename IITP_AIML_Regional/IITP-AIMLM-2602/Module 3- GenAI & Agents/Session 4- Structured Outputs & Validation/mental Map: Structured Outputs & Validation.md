...
direction TB
    ...
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>GenAI & Agents</i><br/>Tokens<br/>Zero-shot<br/>API calls"]
    CURSES["<b>Current Session</b><br/><b>Structured Outputs & Validation</b><br/><i>Shift:</i> Make model outputs machine-safe<br/>JSON schema<br/>Output control"]
end
