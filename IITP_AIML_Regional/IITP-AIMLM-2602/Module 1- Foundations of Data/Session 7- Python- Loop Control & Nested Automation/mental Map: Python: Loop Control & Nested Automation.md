...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI · Computer basics<br/>Command Line (CLI) basics · Variables<br/>For loops · For loops"]
    CURSES["<b>Current Session</b><br/><b>Python: Loop Control & Nested A…</b><br/><i>Shift:</i> Replace manual repetition with loops<br/>For loops<br/>While loops"]
end
