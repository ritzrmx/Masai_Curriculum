...
direction TB
    CURMOD["<b>Current Module Until<br/>Previous Session</b><br/><i>Foundations of Data</i><br/>AI vs ML vs GenAI · Computer basics<br/>Command Line (CLI) basics · Variables"]
    CURSES["<b>Current Session</b><br/><b>Python: Loops & Automation</b><br/><i>Shift:</i> Replace manual repetition with loops<br/>For loops<br/>While loops"]
end
